...
public class TextController : MonoBehaviour
{
    ...
    {
        text.text = "You feel smug for picking the closet door open, and are still armed with " + "a hairclip (now badly bent). Even these achievements together don't give " + "you the courage to climb up the staris to your death!\n\n" + "Press R to Return to the corridor";
        if (Input.GetKeyDown(KeyCode.R)) myState = States.corridor_2;
    }
    ...
    {
        text.text = "You can't believe you sleep in these things. Surely it's time somebody chenaged them. The pleasure of prison life I guess!\n\nPress 'R' to Return to roaming  your cell";
